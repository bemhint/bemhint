...
module.exports = {
    ...
    plugins: {
        ...
        // подключение плагина несколько раз набором конфигов
        '<имя_плагина>': [
            {
                // конфиг
                tech: {
...
**Замечание!** Плагин может быть подключен несколько раз, если он реализован без сайдэффектов (без внутреннего состояния).

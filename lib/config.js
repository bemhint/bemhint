...
module.exports = inherit({
    ...
    __constructor: function(targets, opts) {
        ...
        // console.info('bemhint:config', targets, opts); // DEBUG
        // (folded-levels) If foldedLevels flag passed...
        if( opts && opts.foldedLevels ) {
            // ...then resolve targets to absolute paths
            targets = targets.map((name) => PATH.resolve(name));
        }
